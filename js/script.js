...
const ORYXEN_LOCALES = {
  en: {
    ...
    'create.card1.text': 'Web and mobile apps with governance, security, and clarity from day one — plus MVP prototypes to validate ideas fast.',
    ...
    'contact.panel.eyebrow': 'Start a conversation',
    'contact.panel.subtitle': 'Share the essentials. We’ll reply with next steps.',
  ...
  es: {
    ...
    'create.card1.text': 'Apps web y móviles con gobernanza, seguridad y claridad desde el primer día — además de prototipos MVP para validar ideas rápido.',
    ...
    'contact.panel.eyebrow': 'Empecemos',
    'contact.panel.subtitle': 'Comparte lo esencial. Te responderemos con los próximos pasos.',
  ...
  fr: {
    ...
    'create.card1.text': 'Apps web et mobiles avec gouvernance, sécurité et clarté dès le départ — avec des prototypes MVP pour valider vite les idées.',
    ...
    'contact.panel.eyebrow': 'Démarrons',
    'contact.panel.subtitle': 'Partagez l’essentiel. Nous répondrons avec les prochaines étapes.',
